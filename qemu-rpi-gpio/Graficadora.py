...
def change_pin(pin):
    ...
    try:
        if 1 <= number <= 2:
            ...
            print("Número de pin fuera de rango. Ingrese un número entre 1 y 2")
...
print("Seleccionado pin 1 por defecto")

axbox = plt.axes([0.3, 0.15, 0.4, 0.05]) 
text_box = TextBox(axbox, 'Seleccionar Pin: ')
